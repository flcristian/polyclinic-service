...
public class InitializationCreateTables : Migration
{
    public override void Up()
    {
        ...
        Create.Index("IX_UserAppointments_PatientId")
            .OnTable("UserAppointments")
            .OnColumn("PatientId").Ascending()
            .WithOptions().NonClustered();

        Create.Index("IX_UserAppointments_DoctorId")
            .OnTable("UserAppointments")
            .OnColumn("DoctorId").Ascending()
            .WithOptions().NonClustered();
        
        Create.Index("IX_UserAppointments_AppointmentId")
            .OnTable("UserAppointments")
            .OnColumn("AppointmentId").Ascending()
            .WithOptions().NonClustered();
