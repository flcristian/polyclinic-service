...
{
    [HttpGet("all")]
    [ProducesResponseType(statusCode:200,type:typeof(IEnumerable<GetAppointmentRequest>))]
    [ProducesResponseType(statusCode:404,type:typeof(String))]
    [Produces("application/json")]
    public abstract Task<ActionResult<IEnumerable<GetAppointmentRequest>>> GetAllAppointments();
    
    [HttpGet("appointment/{id}")]
    [ProducesResponseType(statusCode:200,type:typeof(GetAppointmentRequest))]
    [ProducesResponseType(statusCode:404,type:typeof(String))]
    [Produces("application/json")]
    public abstract Task<ActionResult<GetAppointmentRequest>> GetAppointmentById([FromRoute]int id);
    
    [HttpPost("create")]
    [ProducesResponseType(statusCode:201,type:typeof(GetAppointmentRequest))]
    [Produces("application/json")]
    public abstract Task<ActionResult<GetAppointmentRequest>> CreateAppointment([FromBody]CreateAppointmentRequest appointmentRequest);
    
    [HttpPut("update")]
    [ProducesResponseType(statusCode:202,type:typeof(GetAppointmentRequest))]
    [ProducesResponseType(statusCode:404,type:typeof(String))]
    [Produces("application/json")]
    public abstract Task<ActionResult<GetAppointmentRequest>> UpdateAppointment([FromBody]UpdateAppointmentRequest appointmentRequest);
    
    [HttpDelete("delete/{id}")]
    [ProducesResponseType(statusCode:202,type:typeof(String))]
    [ProducesResponseType(statusCode:404,type:typeof(String))]
    [Produces("application/json")]
    public abstract Task<ActionResult<GetAppointmentRequest>> DeleteAppointment([FromRoute]int id);
